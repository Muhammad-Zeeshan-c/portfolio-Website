    ...
    return (
        <>
            <nav className={` text-white h-16 w-full flex justify-between items-center transition-transform duration-300 ease-in ${visible ? "translate-y-0" : "-translate-y-full"}`}>
                ...
                <button className='bg-gradient-to-r bg-pink-500 to-blue-500 px-4 py-2 rounded-full hover:opacity-90 transition-opacity duration-300 text-xl font-bold ease-in  hidden sm:block '>

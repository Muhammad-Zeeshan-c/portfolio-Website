...
function About() {
    return (
        <section className='w-full min-h-screen max-h-[800px] bg-black relative overflow-hidden pt-4 flex flex-col justify-evenly items-center'>
            ...
            <div className='relative max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-20 flex items-start gap-x-10'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <h1 className='text-xl text-white'>Web Developer</h1>
                    ...
                    <div className='mt-5'>
                        <div className='flex flex-col gap-5'>
                            <div className='flex flex-row gap-10'>
                                ...
                                <div className='flex flex-col w-40 h-18 rounded-lg bg-white/5 border-[1px] border-white/10 justify-center items-center text-center'>
                                    <h4 className='text-gray-400'>Specality</h4>
                                    <h4 className='text-white font-medium'>Front End</h4>
                                </div>
